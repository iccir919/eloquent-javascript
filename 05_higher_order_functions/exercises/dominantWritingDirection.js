...
/*
    ...
    a script associated with them. The characterScript and countBy functions 
...
function dominantDirection(text) {
    ...
    return scripts.reduce((accum, val) => accum.count > val.count ? accum : val).name;
}
